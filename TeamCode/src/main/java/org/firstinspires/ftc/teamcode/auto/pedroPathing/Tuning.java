...
import static org.firstinspires.ftc.teamcode.auto.pedroPathing.Tuning.drawCurrent;
import static org.firstinspires.ftc.teamcode.auto.pedroPathing.Tuning.drawCurrentAndHistory;
...
class Drawing {
    ...
    public static void drawRobot(Pose pose, Style style) {
        ...
        pose = new Pose(-(pose.getX() - 72), -(pose.getY() - 72), pose.getHeading() - Math.PI);
